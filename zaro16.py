#!/usr/bin/env python3
"""
zaro16 - Xiangqi Bot (gamevh.net) - engine Pikafish
...
USER = _clean_env(os.environ.get("ZARO16_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO16_PASSWD"), CARO_PASSWD_DIRECT)
