#!/usr/bin/env python3
"""
zaro5 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen23
"""
...
USER = _clean_env(os.environ.get("ZARO5_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO5_PASSWD"), CARO_PASSWD_DIRECT)
