#!/usr/bin/env python3
"""
zaro7 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen7
"""
...
USER = _clean_env(os.environ.get("ZARO7_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO7_PASSWD"), CARO_PASSWD_DIRECT)
