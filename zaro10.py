#!/usr/bin/env python3
"""
zaro10 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen10
"""
...
USER = _clean_env(os.environ.get("ZARO10_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO10_PASSWD"), CARO_PASSWD_DIRECT)
