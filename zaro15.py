#!/usr/bin/env python3
"""
zaro15 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen15
"""
...
USER = _clean_env(os.environ.get("ZARO15_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO15_PASSWD"), CARO_PASSWD_DIRECT)
