#!/usr/bin/env python3
"""
zaro13 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen13
"""
...
USER = _clean_env(os.environ.get("ZARO13_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO13_PASSWD"), CARO_PASSWD_DIRECT)
