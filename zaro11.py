#!/usr/bin/env python3
"""
zaro11 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen11
"""
...
USER = _clean_env(os.environ.get("ZARO11_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO11_PASSWD"), CARO_PASSWD_DIRECT)
