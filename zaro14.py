#!/usr/bin/env python3
"""
zaro14 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen14
"""
...
USER = _clean_env(os.environ.get("ZARO14_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO14_PASSWD"), CARO_PASSWD_DIRECT)
