#!/usr/bin/env python3
"""
zaro2 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen20
"""
...
USER = _clean_env(os.environ.get("ZARO2_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO2_PASSWD"), CARO_PASSWD_DIRECT)
