#!/usr/bin/env python3
"""
zaro4 - Xiangqi Bot (gamevh.net) - engine Pikafish
...
USER = _clean_env(os.environ.get("ZARO4_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO4_PASSWD"), CARO_PASSWD_DIRECT)
