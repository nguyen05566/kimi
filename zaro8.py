#!/usr/bin/env python3
"""
zaro8 - Xiangqi Bot (gamevh.net) - engine Pikafish
Tài khoản: nguyen8
"""
...
USER = _clean_env(os.environ.get("ZARO8_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("ZARO8_PASSWD"), CARO_PASSWD_DIRECT)
