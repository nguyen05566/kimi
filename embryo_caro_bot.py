...
USER = _clean_env(os.environ.get("GAMEVH_USER") or os.environ.get("CARO_USER1") or os.environ.get("CARO_USER"), CARO_USER_DIRECT)
PASSWD = _clean_env(os.environ.get("GAMEVH_PASS") or os.environ.get("CARO_PASSWD1") or os.environ.get("CARO_PASSWD"), CARO_PASSWD_DIRECT)
